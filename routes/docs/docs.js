...
const Acceleration = new Formula("func Acceleration(force, mass float64) (value float64, measurementUnit string)", "a=f/m.", "m/s^2")
...
const PendulumPeriod = new Formula("func PendulumPeriod(pendulumLength float64) (time float64, measurementUnit string)", "(2 * greekPi) * math.Sqrt(pendulumLength/G)", "s")
...
const PotentialGravEner = new Formula("func PotentialGravEner(mass, height float64) (value float64, measurementUnit string)", "", "J")
...
const RelativDist = new Formula("func RelativDist(nonTravelerDistance, speed float64) (contractedDistance float64, measurementUnit string)", "2 * initialVelocity * Sine(angleInDeg/1 radiant)", "s")
...
const Voltage = new Formula("func Voltage(charge, distance1, distance2 float64) (value float64, measurementUnit string)", "", "V")
